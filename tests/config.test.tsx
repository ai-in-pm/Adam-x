...
test("loads user instructions + project doc when adam-x.md is present", () => {
  // 1) seed memfs: a config JSON, an instructions.md, and an adam-x.md in the cwd
  ...
  // and now our fake adam-x.md in the cwd:
  const codexPath = join(testDir, "adam-x.md");

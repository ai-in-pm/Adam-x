...
# run.sh — Create a new run_N directory for an Adam-X task, optionally bootstrapped from a template,
# then launch Adam-X with the task description from task.yaml.
#
# Usage:
